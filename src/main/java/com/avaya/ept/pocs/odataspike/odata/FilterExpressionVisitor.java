...
public class FilterExpressionVisitor implements ExpressionVisitor<Object> {
    ...
    public Object visitMember(final Member member) throws ExpressionVisitException, ODataApplicationException {
        ...
        // segment and a primitive property
        // has been addressed. We can be sure, that the property exists because the
        // UriParser checks if the
    ...
    public Object visitMethodCall(MethodKind methodCall, List<Object> parameters)
        ...
        if (methodCall == MethodKind.CONTAINS) {
            ...
            //
            // First the method visistMember is called, which returns the current String
            // value of the property.
            // After that the method visitLiteral is called with the string literal '1024
            // MB',
    ...
    public Object visitBinaryOperator(BinaryOperatorKind operator, Object left, List<Object> right)
        ...
        throw new UnsupportedOperationException("Unimplemented method 'visitBinaryOperator'");
    }
}